...
namespace CS.Hardware.SequentialLogic
{
    public class RAM64
    {
        ...
        private const int SEL_SIZE = 6;
        public bool Load { get; set; }
        private List<RAM8> _rams;
        ...
        private bool[] AddressLow { get { return new bool[] { _address[3], _address[4], _address[5] }; } }
        private bool[] _out = new bool[BITS];
        public bool[] Out { get { return _out; } }
        public bool[] In { get; set; } = new bool[BITS];

        public void SetAddress(bool s1 = false, bool s2 = false, bool s3 = false, bool s4 = false, bool s5 = false, bool s6 = false, bool update = true)
            => SetAddress(new bool[] { s1, s2, s3, s4, s5, s6 }, update);
        ...
        //public List<RAM8> DebugRam { get { return _rams; } }
