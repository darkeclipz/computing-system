...
namespace CS.Hardware.SequentialLogic
{
    public class RAM4K
    {
        ...
        private const int SEL_SIZE = 12;
        public bool Load { get; set; }
        private List<RAM512> _rams;
        ...
        private bool[] AddressLow { get { return new bool[] { _address[3], _address[4], _address[5], _address[6], _address[7], _address[8], _address[9], _address[10], _address[11] }; } }
        private bool[] _out = new bool[BITS];
        public bool[] Out { get { return _out; } }
        public bool[] In { get; set; } = new bool[BITS];

        public void SetAddress(bool s1 = false, bool s2 = false, bool s3 = false, bool s4 = false, bool s5 = false, bool s6 = false, bool s7 = true, bool s8 = true, bool s9 = true, bool s10 = true, bool s11 = true, bool s12 = true, bool update = true)
            => SetAddress(new bool[] { s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12 }, update);
        ...
        public RAM4K()
        {
            _mux = new Mux8Way16();
            _dmux = new DMux8Way();
            _rams = new List<RAM512>();
            for (int i = 0; i < SIZE; i++)
            {
                _rams.Add(new RAM512());
            }
        }

        //private List<RAM512> DebugRam { get { return _rams; } }
